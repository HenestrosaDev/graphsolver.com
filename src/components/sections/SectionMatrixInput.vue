...
<template>
	...
	>
		<div
			class="bg-slate-50 px-4 py-3 border-b border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-4"
		>
			<div class="flex items-center w-full justify-between gap-4">
				<div class="flex items-center gap-3">
					<span
						class="text-xs font-bold text-slate-500 uppercase tracking-wide select-none"
					>
						Vértices
					</span>
		...
		<div class="p-4 sm:p-6 overflow-x-auto w-full flex justify-center bg-white">
			<div
				class="inline-block rounded-lg border border-slate-200 overflow-hidden shadow-sm"
			...
			>
				<table class="border-collapse table-fixed w-auto">
					<thead>
						<tr>
							<th
								class="p-2 bg-slate-50 border-r border-b border-slate-200 w-10 sm:w-12"
							></th>
